...
9. W celu dokonania Odblokowania Jednorazowego Usługobiorca powinien, będąc zalogowanym na Konto, wybrać przy danym Dopasowaniu opcję jego odblokowania, złożyć oświadczenia wskazane w ust. 8 pkt 3 powyżej oraz dokonać zapłaty za pośrednictwem operatora płatności.
...
19. Niezależnie od trybu opisanego w ust. 2 powyżej, Konto może zostać utworzone poprzez uwierzytelnienie kontem Google. W takim przypadku Usługobiorca wybiera opcję „Kontynuuj z Google", uwierzytelnia się w usłudze Google i składa oświadczenie, o którym mowa w ust. 2 pkt 3 powyżej. Usługodawca otrzymuje wówczas od Google adres poczty elektronicznej, imię, nazwisko oraz zdjęcie profilowe przypisane do konta Google Usługobiorcy. Utworzenie Konta w tym trybie nie wymaga wprowadzenia kodu aktywacyjnego, a Umowa o Konto zostaje zawarta z chwilą pomyślnego uwierzytelnienia.
20. W formularzu, o którym mowa w ust. 2 pkt 2 powyżej, Usługobiorca może dodatkowo wyrazić zgodę na otrzymywanie informacji handlowych pod podany przez siebie adres poczty elektronicznej. **Wyrażenie tej zgody jest dobrowolne i nie warunkuje utworzenia Konta ani zawarcia jakiejkolwiek Umowy** – jej brak nie ogranicza zakresu, dostępności ani ceny Usług. Zgoda może zostać cofnięta w każdym czasie, bez podania przyczyny, w ustawieniach Konta albo poprzez kliknięcie w link umożliwiający rezygnację, dołączany do każdej przesłanej wiadomości. Zasady dostarczania informacji handlowych określa [Regulamin newslettera](${SCIEZKI.regulaminNewslettera}), a zasady przetwarzania danych osobowych w tym celu – [Polityka prywatności](${SCIEZKI.politykaPrywatnosci}).
