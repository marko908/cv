...
1. Użyte w Regulaminie wyrazy pisane wielką literą mają następujące znaczenie:
   ...
   16) **Umowa** – umowa o dostarczanie usługi cyfrowej w rozumieniu Ustawy o prawach konsumenta, zawierana pomiędzy Usługodawcą a Usługobiorcą; Regulamin wyróżnia Umowę o Konto (§ 4 ust. 5) oraz Umowę Subskrypcji i Odblokowanie Jednorazowe (§ 4 ust. 9–11),
...
3. Alternatywnie, Usługobiorca może utworzyć Konto przy użyciu posiadanego konta Google. W takim wypadku należy wykonać czynności opisane w ust. 2 pkt 1 i 3 powyżej, wybrać opcję rejestracji przy użyciu konta Google oraz potwierdzić udostępnienie danych zgodnie z komunikatem wyświetlanym przez dostawcę tej usługi.
4. Usługodawca nie stosuje aktywacji Konta w drodze kliknięcia w link przesłany pocztą elektroniczną. Aktywacja następuje wyłącznie przez wprowadzenie kodu, o którym mowa w ust. 2 pkt 5 powyżej.
5. Wprowadzenie prawidłowego kodu aktywacyjnego albo potwierdzenie rejestracji przy użyciu konta Google jest równoznaczne z zawarciem nieodpłatnej Umowy o Konto, na czas nieoznaczony.
6. Do chwili utworzenia Konta dane wprowadzone przez Użytkownika w kreatorze CV przechowywane są wyłącznie w pamięci przeglądarki na jego urządzeniu. Usługodawca nie ma do nich dostępu, nie odpowiada za ich utratę wynikającą z wyczyszczenia danych przeglądarki, zmiany urządzenia lub korzystania z trybu prywatnego, i zaleca utworzenie Konta przed wprowadzeniem obszerniejszych treści.
7. Po utworzeniu Konta dane wprowadzone przez Użytkownika przed rejestracją są jednorazowo przenoszone na Konto. Od tej chwili Treści Usługobiorcy są przechowywane na Koncie i dostępne na każdym urządzeniu, na którym Usługobiorca zaloguje się do Aplikacji.
8. Usługodawca informuje, a Usługobiorca przyjmuje do wiadomości, że zachowanie zgodności Usługi z Umową nie wymaga instalowania przez Usługobiorcę jakichkolwiek aktualizacji – Aplikacja jest udostępniana w wersji przeglądarkowej, a aktualizacje wprowadza Usługodawca po swojej stronie.
9. W celu zawarcia Umowy Subskrypcji Usługobiorca powinien:
...
10. W celu dokonania Odblokowania Jednorazowego Usługobiorca powinien, będąc zalogowanym na Konto, wybrać przy danym Dopasowaniu opcję jego odblokowania, złożyć oświadczenia wskazane w ust. 9 pkt 3 powyżej oraz dokonać zapłaty za pośrednictwem operatora płatności.
11. Umowa Subskrypcji albo umowa, na podstawie której następuje Odblokowanie Jednorazowe, zostaje zawarta z chwilą otrzymania przez Usługodawcę potwierdzenia dokonania płatności od operatora płatności. Niezwłocznie po tej chwili Usługodawca udostępnia Usługobiorcy dostęp do Usług Płatnych oraz przesyła na jego adres poczty elektronicznej potwierdzenie zawarcia Umowy wraz z jej treścią.
12. Postanowienia ust. 13–16 poniżej stosuje się wyłącznie do Usługobiorców będących Konsumentami lub Przedsiębiorcami na prawach Konsumenta.
13. W przypadku braku udzielenia Usługobiorcy dostępu do Usługi niezwłocznie po zawarciu Umowy, Usługobiorca wzywa Usługodawcę do niezwłocznego udzielenia dostępu do Usługi. Wezwanie może zostać wysłane za pomocą poczty elektronicznej, pod adres wskazany w § 1 ust. 5 pkt 1 Regulaminu. W przypadku, gdy Usługodawca nie udzieli dostępu do Usługi niezwłocznie po otrzymaniu wezwania, Usługobiorca może odstąpić od Umowy.
14. Niezależnie od postanowień ust. 13 powyżej, w przypadku braku udzielenia dostępu do Usługi Usługobiorca może odstąpić od Umowy bez wzywania Usługodawcy do udzielenia dostępu, jeżeli zachodzi co najmniej jeden z przypadków wskazanych w art. 43j ust. 5 Ustawy o prawach konsumenta.
15. Niezależnie od postanowień ust. 13–14 powyżej, Usługobiorca może w każdym czasie i bez podania przyczyny wypowiedzieć Umowę o Konto ze skutkiem natychmiastowym poprzez samodzielne usunięcie Konta w ustawieniach Aplikacji albo poprzez wysłanie dyspozycji usunięcia Konta na adres wskazany w § 1 ust. 5 pkt 1 Regulaminu.
16. Odstąpienie od Umowy albo jej wypowiedzenie, niezależnie od podstawy dokonania tej czynności, następuje poprzez złożenie Usługodawcy stosownego oświadczenia. Oświadczenie może zostać wysłane za pomocą poczty elektronicznej, pod adres wskazany w § 1 ust. 5 pkt 1 Regulaminu.
17. W przypadku naruszenia przez Usługobiorcę postanowień Regulaminu i nieusunięcia tego naruszenia pomimo otrzymania wezwania, Usługodawca może wypowiedzieć Umowę z zachowaniem okresu wypowiedzenia wynoszącego 7 (siedem) dni, poprzez złożenie Usługobiorcy oświadczenia o wypowiedzeniu za pomocą poczty elektronicznej. Po upływie okresu wypowiedzenia Usługodawca wstrzymuje dostarczanie Usługi. W czasie trwania okresu wypowiedzenia Usługodawca może zablokować Usługobiorcy dostęp do Usługi, jeżeli jest to niezbędne w celu zapobieżenia dalszym naruszeniom. Usługodawca zwraca Usługobiorcy Opłatę Subskrypcyjną w części przypadającej na niewykorzystany Okres Rozliczeniowy, chyba że wypowiedzenie nastąpiło z powodu naruszenia § 14 ust. 4 Regulaminu.
18. Usunięcie Konta powoduje trwałe usunięcie Treści Usługobiorcy, w tym zapisanych CV, historii Dopasowań oraz zdjęć. Usunięcie jest nieodwracalne, a Usługodawca nie tworzy kopii archiwalnych umożliwiających ich odtworzenie. Nie dotyczy to danych, których dalsze przechowywanie jest wymagane przepisami prawa (w szczególności dokumentacji księgowej) albo niezbędne do ustalenia, dochodzenia lub obrony przed roszczeniami – w zakresie i przez okres opisany w Polityce prywatności.
19. **Usługodawca zaleca pobranie kopii danych przed usunięciem Konta.** Na żądanie zgłoszone na adres wskazany w § 1 ust. 5 pkt 1 Regulaminu Usługodawca nieodpłatnie udostępnia Usługobiorcy komplet jego danych w powszechnie używanym formacie nadającym się do odczytu maszynowego (JSON), obejmujący zapisane CV, historię Dopasowań oraz dane Konta – niezwłocznie, nie później niż w terminie 30 dni od dnia otrzymania żądania. Niezależnie od powyższego, Usługobiorca może w każdej chwili pobrać każde ze swoich CV w pliku PDF bezpośrednio z Aplikacji.
...
8. Odstąpienie od Umowy Subskrypcji albo od umowy, na podstawie której nastąpiło Odblokowanie Jednorazowe, nie powoduje usunięcia Konta ani Treści Usługobiorcy. Usunięcie Konta następuje wyłącznie na zasadach opisanych w § 4 ust. 15 Regulaminu.
